...
export default function Donar() {
  ...
  if (isLoading || isError || isLoadingOrg || isErrorOrg)
    return <FetchInfo isLoading={isLoading} isError={isError} />;
  return (
    <DefaultPage>
      <section className="mt-40 flex items-center justify-evenly flex-col gap-10 mb-10 ">
        ...
        {org?.mp_link && <MpBoton mp_link={org.mp_link} />}
      </section>
    </DefaultPage>
  );
}
